[
  {
    ...
    "_links": {
      ...
      "wp:attachment": [
        {
          "href": "https://opportunitieshub.ng/wp-json/wp/v2/media?parent=4752"
        }
      ],
      "wp:term": [
        {
  ...
  },
  {
    ...
    "_links": {
      "self": [
        {
          "href": "https://opportunitieshub.ng/wp-json/wp/v2/posts/4746",
          "targetHints": {
            "allow": [
              "GET"
            ]
  ...
  {
    "id": 4709,
    "date": "2025-06-10T16:36:53",
    "date_gmt": "2025-06-10T16:36:53",
    "guid": {
      "rendered": "https://opportunitieshub.ng/?p=4709"
    },
    "modified": "2025-06-10T16:36:58",
    "modified_gmt": "2025-06-10T16:36:58",
    "slug": "apply-for-africa-initiative-for-inclusive-development-aiidev-green-school-activation-programme-2025",
    "status": "publish",
    "type": "post",
    "link": "https://opportunitieshub.ng/2025/06/10/apply-for-africa-initiative-for-inclusive-development-aiidev-green-school-activation-programme-2025/",
    "title": {
      "rendered": "Apply for Africa Initiative for Inclusive Development (AIIDEV) Green School Activation Programme 2025"
    },
    "content": {
      "rendered": "\n<p>Applications are open for the&nbsp;AIIDEV Africa Green School Activation Programme 2025.</p>\n\n\n\n<p>The Green School Activation Programme (GSAP) is a transformative initiative aimed at promoting green education through a whole-school approach in secondary schools across Africa.</p>\n\n\n\n<p>GSAP is designed to restore green and healthy learning environments, enhance food security through vertical gardens, strengthen climate education, and embed circular economy practices in schools.</p>\n\n\n\n<p>By integrating food security through sustainable gardening, climate education, and circularity practices into the school activities and infrastructure, the programme seeks to align educational institutions with the targets set by the Sustainable Development Goals (SDGs), specifically SDG 2.2 (ending malnutrition), SDG 4.a (creating inclusive and effective learning environments), and SDG 13.3 (enhancing climate education and capacity).</p>\n\n\n\n<p>The implementation of GSAP follows a structured, four-phase framework designed to build awareness, develop capacity, and drive long-term transformation in schools.</p>\n\n\n\n<p>These phases include a state-level summit, technical training for educators, on-site school activation, and a final stage of showcase, awards, and recognition.</p>\n\n\n\n<p>By empowering teachers and schools with practical knowledge and sustainable strategies, GSAP creates learning environments that are conducive, eco-conscious, and resilient, setting the stage for a more sustainable future for students and their communities.</p>\n\n\n\n<h3 class=\"wp-block-heading\"><strong>Core Learning Areas of Green School Activation Programme</strong></h3>\n\n\n\n<ul class=\"wp-block-list\">\n<li>Green Education and SDGs</li>\n\n\n\n<li>Circular Economy and Waste Management</li>\n\n\n\n<li>SDG-Aligned Curriculum Development</li>\n\n\n\n<li>Sustainable Gardening and Food Systems</li>\n\n\n\n<li>Climate Change and Environmental Literacy</li>\n\n\n\n<li>Energy Audit and Conservation</li>\n\n\n\n<li>Green Environmental Practices</li>\n\n\n\n<li>Waste Audit and Reduction Strategy</li>\n</ul>\n\n\n\n<h3 class=\"wp-block-heading\"><strong>Eligibility</strong></h3>\n\n\n\n<ul class=\"wp-block-list\">\n<li>Must be a secondary school teacher currently teaching in Abuja, Lagos, or Oyo State.</li>\n\n\n\n<li>Teachers of subjects related to Science, Agriculture, Civic Education, Geography, or Environmental Studies are strongly encouraged to apply.</li>\n\n\n\n<li>Open to both public and private secondary schools.</li>\n\n\n\n<li>Each school should nominate at least three (3) teachers, including one principal or vice-principal, to ensure school-wide implementation and support.</li>\n\n\n\n<li>Applicants must demonstrate a strong interest in sustainability and climate action.</li>\n\n\n\n<li>Must be willing to attend all training sessions (virtual or physical) and fully participate in the programme’s activities.</li>\n\n\n\n<li>Must have basic digital literacy and access to a smartphone, tablet, or computer to engage in virtual learning sessions.</li>\n\n\n\n<li>Schools should be open to hosting activation activities, such as vertical gardens, waste sorting stations, or green clubs.</li>\n\n\n\n<li>Should be able to work collaboratively with other teachers and school leadership to implement the GSAP goals.</li>\n</ul>\n\n\n\n<p>Deadline: July 15, 2025</p>\n\n\n\n<h2 class=\"wp-block-heading\"><a href=\"https://docs.google.com/forms/d/e/1FAIpQLSe3Lcby5-45D2PhQsC2O_RaKgVwKGh7MhbPJZzXJMHwccYSaw/viewform\" target=\"_blank\" rel=\"noreferrer noopener\">Apply here</a></h2>\n",
      "protected": false
    },
    "excerpt": {
